...
if main_df.empty:
    ...
    with tab1: # 下單投注
        ...
        st.components.v1.html("""
            <div id="clock-container" style="display: flex; align-items: center; background-color: #f8f9fb; padding: 8px 15px; border-radius: 6px; border-left: 5px solid #ff4b4b; font-family: sans-serif; margin-bottom: 5px;">
                <span id="clock" style="font-size: 15px; font-weight: 600; color: #31333f;">載入中...</span>
            </div>
            <script>
